...
# Oddball stimuli
ODDBALL_STANDARD_IMAGE = STIM_DIR / "oddball" / "standard_checkerboard.png"
ODDBALL_TARGET_IMAGE = STIM_DIR / "oddball" / "target_checkerboard.png"
...
# Unicorn Recorder default example:
# triggers received via UDP on 127.0.0.1 : 1000
UDP_IP = "127.0.0.1"
UDP_PORT = 1000
...
# Marker codes (single-digit ASCII recommended for simplicity)
MARKERS = {
    "practice_standard": 1,
    "practice_target": 2,
    "oddball_standard": 1,
...
def send_udp_trigger(code):
    """
    Unicorn Recorder expects trigger values as ASCII characters via UDP.
    Example: b"1", b"2", b"3"
    """
...
def send_trigger_on_flip(win, code):
    """
    Schedule trigger exactly on next screen flip.
    """
