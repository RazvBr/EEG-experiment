...
def send_trigger(code):
    """
    Înlocuiește cu codul real pentru markeri EEG, dacă folosiți triggers.
    """
    pass
...
def run_oddball_practice(win, n_targets=3):
...
def run_oddball_block(win, writer, fieldnames, participant_code, n_targets=40):
    ...
    run_oddball_practice(win, n_targets=3)
    ...
    for trial_index, trial in enumerate(trials, start=1):
        ...
        trigger_code = 11 if trial["trial_type"] == "standard" else 12
